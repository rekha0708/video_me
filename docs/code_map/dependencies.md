...
- `services.dashboard_api` → `core.config`, `core.models.dashboard`, `core.models.profile`, `core.storage`, `scripts.check_runtime_readiness`, `services.chat_service`, `services.dashboard_repository`
